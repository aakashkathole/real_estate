...
class OfficesScreen extends StatelessWidget {
  ...
  OfficesScreen({required this.category});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            Text(
              "Here you can find all the details about available offices.",
            ...
            Expanded(
              child: StreamBuilder(
                stream: FirebaseFirestore.instance
                    ...
                    .where('propertyType', isEqualTo: "Office Space") // Filter by category
