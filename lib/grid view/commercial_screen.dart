...
class CommercialScreen extends StatelessWidget {
  ...
  CommercialScreen({required this.category});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            Text(
              "Here you can find all the details about available commercial.",
            ...
            Expanded(
              child: StreamBuilder(
                stream: FirebaseFirestore.instance
                    ...
                    .where('propertyKind', isEqualTo: "Commercial") // Filter by category
