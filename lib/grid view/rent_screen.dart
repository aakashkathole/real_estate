...
class RentScreen extends StatelessWidget {
  ...
  RentScreen({required this.category});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            Text(
              "Here you can find all the details about available property's for rent.",
            ...
            Expanded(
              child: StreamBuilder(
                stream: FirebaseFirestore.instance
                    ...
                    .where('lookingFor', isEqualTo: "Rent") // Filter by category
