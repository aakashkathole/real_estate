      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            Text(
              "Here you can find all the details about available farm lands.",
            ...
            Expanded(
              child: StreamBuilder(
                stream: FirebaseFirestore.instance
                    ...
                    .where('propertyType', isEqualTo: "Farm Land") // Filter by category
