...
class BuyScreen extends StatelessWidget {
  ...
  BuyScreen({required this.category});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            Text(
              "Here you can find all the details about available property's for sell.",
            ...
            Expanded(
              child: StreamBuilder(
                stream: FirebaseFirestore.instance
                    ...
                    .where('lookingFor', isEqualTo: "Sell") // Filter by category
